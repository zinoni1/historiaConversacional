public class Historia {
    ...
    public static String agafarHistoria() {
        return "Any 2120 D.C. La nau PiaXXII explora l'espai inhòspit en direcció al planeta SUMMEM on es creu que hi poden haver les \n"
                +
                "\n"
                +
                ...
                "\n"
                +
                "para. En cada partida està en llocs diferents.\n" +
                "\n" +
                ...
                "\n"
                +
                "poder agafar l’eina que ens permetrà reparar els motors.\n" +
                "\n" +
                "VESTIT ESPACIAL\n" +
                "\n" +
                ...
                "\n" +
                "podrem obrir-la i caldrà que ho demanem a iHall.\n" +
                "\n" +
                ...
                "\n"
                +
                "al costat de la que es trobi en aquell moment.\n" +
                "\n" +
                "Es pot fer servir:\n" +
                "\n" +
